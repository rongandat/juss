...
?>
<div class="box featured-box list-carousel<?php if ($this->config->get('RGen_carouselArrow') == 'tr' || $modprd == 'prd2') { ?> arrow-tr<?php } ?><?php if ($modprd == 'prd2') { ?> modprd2<?php } ?><?php if ($modprd == 'prd1' || $modprd == '') { ?> modprd1<?php } ?>" id="featured-box<?php echo $module; ?>">
	<div class="box-heading header-1"><?php echo $heading_title; ?></div>
	<ul class="box-product">
		<?php foreach ($products as $product) { ?>
		<li class="carousel-item">
