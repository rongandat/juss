	...
	<div class="content-body">
		...
		<div class="product-info<?php if ($oc == 'oc') { ?> prd-layout1<?php } ?>">
			...
			<div class="<?php if ($th == 1 || $oc == 'oc') { ?>th-b <?php } else { ?>th-l <?php } ?><?php if ($this->config->get('RGen_productZoom') == 1) { ?>popup-zoom <?php } ?>left prdimage-wrapper<?php if ($images == array()) { ?> no-th<?php } ?>">
				...
				<?php /* ABOVE IMAGES CONTENT
				******************************/	?>
				<?php 
				$i = 1;
				if (isset($this->document->RGen_custom)) {
				foreach ($this->document->RGen_custom as $result) {
				if (isset($result['prd_status']) && $result['prd_status'] == "selp") {
				if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
					<?php 
					if ($result['status']) {
					if ($result['layout_id'] == 2 || $this->document->Layout == $result['layout_id']) {
					if ($result['position'] == 'pd_above_img') { ?>
					<div id="prd-aboveimg<?php echo $i; ?>" class="prdpg-aimg<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>">
				...
				******************************/
				...
				if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
					...
					<?php if ($result['layout_id'] == 2 || $this->document->Layout == $result['layout_id']) { ?>
					<?php if ($result['position'] == 'pd_below_img') { ?>
					<div id="prd-belowimg<?php echo $i; ?>" class="prdpg-bimg<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>">
						<?php if($result['title'][$this->config->get('config_language_id')]){ ?>
						<h2 class='header-2'><?php echo $result['title'][$this->config->get('config_language_id')]; ?></h2>
						<?php } ?>
						<div class="custom-data">
			...
			<div class="right prdoptions-wrapper">
				...
				******************************/
				...
				if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
					...
					if ($result['status']) {
					if ($result['layout_id'] == 2 || $this->document->Layout == $result['layout_id']) {
					if ($result['position'] == 'pd_above_options') { ?>
					<div id="prd-aboveop<?php echo $i; ?>" class="prdpg-aop<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>">
						<?php if($result['title'][$this->config->get('config_language_id')]){ ?>
						<h2 class='header-2'><?php echo $result['title'][$this->config->get('config_language_id')]; ?></h2>
						<?php } ?>
						<div class="custom-data">
				...
				******************************/	
				...
				if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
					...
					if ($result['status']) {
					if ($result['layout_id'] == 2 || $this->document->Layout == $result['layout_id']) {
					if ($result['position'] == 'pd_below_options') { ?>
					<div id="prd-belowop<?php echo $i; ?>" class="prdpg-bop<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>">
						<?php if($result['title'][$this->config->get('config_language_id')]){ ?>
						<h2 class='header-2'><?php echo $result['title'][$this->config->get('config_language_id')]; ?></h2>
						<?php } ?>
						<div class="custom-data">
			...
			******************************/	?>
			...
			<?php if (isset($result['prd_status']) && $result['prd_status'] == "selp") { ?>
			<?php if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
				<?php if ($result['status']) { ?>
				<?php if ($result['layout_id'] == 2 || $this->document->Layout == $result['layout_id']) { ?>
				<?php if ($result['position'] == 'pd_above_tb') { ?>
				<div id="prd-abovetb<?php echo $i; ?>" class="prdpg-atb<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>">
					<?php if($result['title'][$this->config->get('config_language_id')]){ ?>
					<h2 class='header-2'><?php echo $result['title'][$this->config->get('config_language_id')]; ?></h2>
					<?php } ?>
					<div class="custom-data">
			...
			<div class="<?php if ($oc == '' && $reviewTab == '') { ?>left <?php } ?>tabs-wrapper<?php if ($reviewTab == 1 || $oc == 'oc') { ?> review-in<?php } ?>">
				...
				<div id="tabs" class="htabs">
					...
					******************************/
					...
					<?php if (isset($result['prd_status']) && $result['prd_status'] == "selp") { ?>
					<?php if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
						<?php if ($result['status'] && $this->document->Layout == $result['layout_id'] && $result['position'] == 'pd_tb') { ?>
						<?php if($result['title'][$this->config->get('config_language_id')]){ ?>
						<a href="#prd-extb<?php echo $prdextb; ?>" class="<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>"><?php echo $result['title'][$this->config->get('config_language_id')]; ?></a>
						<?php } ?>
						<?php } ?>
					<?php } ?>
					<?php }else{ ?>
				...
				******************************/
				...
				<?php if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
					...
					<?php if ($result['position'] == 'pd_tb' && $result['title'][$this->config->get('config_language_id')] != "") { ?>
					<?php if(isset($result['description'][$this->config->get('config_language_id')])){ ?>
					<div id="prd-extb<?php echo $prdextb; ?>" class="tab-content<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>">
						<div<?php if ($oc == '' && $reviewTab == '') { ?> class="scrollPane"<?php } ?>><?php echo html_entity_decode($result['description'][$this->config->get('config_language_id')], ENT_QUOTES, 'UTF-8'); ?></div>
					</div>
					<?php } ?>
					<?php } ?>
		...
		******************************/
		...
		<?php if(isset($result['prd_status'], $result['prd']) && in_array($product_id, $result['prd'])) { ?>
			...
			if ($result['status']) {
			if ($result['layout_id'] == 2 || $this->document->Layout == $result['layout_id']) {
			if ($result['position'] == 'pd_above_rel') { ?>
			<div id="prd-aboverel<?php echo $i; ?>" class="prdpg-arl<?php if($result['class']){ if($result['class'] != ''){ ?> <?php echo $result['class']; ?><?php } } ?>">
				<?php if($result['title'][$this->config->get('config_language_id')]){ ?>
				<h2 class='header-2'><?php echo $result['title'][$this->config->get('config_language_id')]; ?></h2>
				<?php } ?>
				<div class="custom-data">
